...
def start(m, res=False):
    ...
    bot.send_message(
        m.from_user.id, text='Выбери понравившуюся категорию', reply_markup=keyboard)
...
key_1 = types.InlineKeyboardButton(
    text='Серьезое чтение', callback_data='data1')
# И добавляем кнопку на экран
keyboard.add(key_1)
key_2 = types.InlineKeyboardButton(
    text='Психология, мотивация', callback_data='2')
keyboard.add(key_2)
...
key_1_1 = types.InlineKeyboardButton(
    text='Русская классическая литератра', callback_data='data1_1')
keyboard1.add(key_1_1)
key_1_2 = types.InlineKeyboardButton(
    text='Зарубежная классическая литература', callback_data='data1_2')
keyboard1.add(key_1_2)
key_1_3 = types.InlineKeyboardButton(
    text='Советская литература', callback_data='data1_3')
...
def message(call):
    if call.data == "data1":
        bot.send_message(call.message.chat.id,
                         text='Выбери категорию', reply_markup=keyboard1)
...
def message(call):
    if call.data == "data2":
        bot.send_message(call.message.chat.id,
                         text='Выбери категорию', reply_markup=keyboard2)
