...
${NORMAL}" #sistem info mesage
    ...
    arr+=("start app.py")
    res+=(". ${PATH_CURR_REPO}/NPython/Pala/flask/selfedu/flask/v_curr/.d/.sh/_start_check.sh -s")
    ...
    res+=(". ${PATH_CURR_REPO}/NPython/Pala/flask/selfedu/flask/v_curr/.d/.sh/_start_check.sh -c")

    arr+=("correct routaddr_namefn.lst2")
    res+=("edit_ ${PATH_CURR_REPO}/NPython/Pala/flask/selfedu/flask/v_curr/.d/.lst2/routaddr_namefn.lst2")
