...
fntmp_f76e523211() {
    ...
    local filename=${PATH_CURR_REPO}/NPython/sfu/tasks_II/v_5/via.sh
...
${NORMAL}" #sistem info mesage
    ...
    # res+=(". ${PATH_CURR_REPO}/NPython/sfu/tasks_II/v_5/.d/.sh/_cr_app_py.sh ;\
    # . ${PATH_CURR_REPO}/NPython/sfu/tasks_II/v_5/.d/.sh/_start_check.sh -s")
    ...
    # REPOBARE/_repo/NPython/sfu/tasks_II/v_5/.d/.ecce/legitur.man
