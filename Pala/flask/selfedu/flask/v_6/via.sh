...
fntmp_f76e523211() {
    ...
    local filename=${PATH_CURR_REPO}/NPython/Pala/flask/selfedu/flask/v_6/via.sh
...
${NORMAL}" #sistem info mesage
    ...
    # res+=(". ${PATH_CURR_REPO}/NPython/Pala/flask/selfedu/flask/v_6/.d/.sh/_cr_app_py.sh ;\
    # . ${PATH_CURR_REPO}/NPython/Pala/flask/selfedu/flask/v_6/.d/.sh/_start_check.sh -s")
    ...
    # REPOBARE/_repo/NPython/Pala/flask/selfedu/flask/v_6/.d/.ecce/legitur.man
